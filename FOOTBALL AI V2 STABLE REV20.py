# ============================================================
# FOOTBALL AI V2 STABLE REV20 – History & Settlement Redesign
# ============================================================
...
# ============================================================
# CUSTOM CSS (HT/FT card styles tetap)
# ============================================================
st.markdown("""
<style>
...
def _settlement_result(row):
    ...
    # Tentukan actual over/under
    if total_ft > ou_line:
        actual_over = 1
    elif total_ft < ou_line:
        actual_over = 0
    else:
        return "PUSH"  # tepat sama dengan garis
...
def render_settlement():
    ...
    # Tampilkan ringkasan per pertandingan
