...
# ============================================================
# PROFIT CALCULATOR (wrapper, bisa digantikan SettlementEngine nanti)
# ============================================================
class ProfitCalculator:
    @staticmethod
    def calculate(row: dict, stake: float = 100000.0) -> Tuple[float, str]:
        # Gunakan SettlementEngine untuk perhitungan profit OU saja
        ...
        with st.expander(f"▶ {home_safe} vs {away_safe} ({info})"):
            ...
            if st.session_state.get(f"processing_{match_uid}", False):
                ...
                if valid:
                    ...
                    # Gunakan SettlementEngine untuk menghitung semua profit
