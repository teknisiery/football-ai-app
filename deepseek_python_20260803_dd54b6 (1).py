            ...
            with cols[i]:
                ...
                if cs_recs and i < len(cs_recs):
                    ...
                    if rec[0] == h and rec[1] == a:
                        ...
                        st.caption(f"Odds: {odds:.2f}")
                        st.caption(f"Stake: Rp{stake:,}")
