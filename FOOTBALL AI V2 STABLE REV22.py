# ============================================================
# FOOTBALL AI V2 STABLE REV21 – CSV Fix + Settlement Accordion + Profit
# ============================================================
...
class GitHubStorageProvider(StorageProvider):
    ...
    def save_dataframe(self, resource: Resource, df: pd.DataFrame):
        ...
        print("=== GitHubStorageProvider.save_dataframe ===")
...
# ============================================================
# DATABASE MANAGER (dengan normalisasi untuk history)
# ============================================================
class DatabaseManager:
    ...
    def load_history(self) -> pd.DataFrame:
        ...
        df = PendingContract.normalize(df)   # normalisasi wajib
        return df

    def save_history(self, df: pd.DataFrame):
        df = PendingContract.normalize(df)   # jamin semua kolom ada
...
def build_pending(ctx: PredictionContext) -> PendingResult:
    ...
    print("=== BEFORE save_pending ===")
    print("columns:", final_df.columns.tolist())
    print("first row:", final_df.iloc[0].to_dict())
...
def save_pending_score(idx, ht_home, ht_away, ft_home, ft_away, pending_all, db):
    ...
    if valid:
        ...
        print("=== BEFORE save_history ===")
        print("columns:", history.columns.tolist())
        print("last row:", history.tail(1).to_dict("records"))
