...
# ----------------------------------------------------------------------
# Duplikasi minimal ResourceRegistry & ProfitCalculator (sementara)
# agar modul ini tidak bergantung pada app.py
# ----------------------------------------------------------------------
...
def evaluate_model(storage) -> dict:
    # Catatan: cache tidak digunakan di sini karena ini modul murni,
    # pemanggil tetap bisa menggunakan st.cache_data di app.py.
    result = {}
    try:
