# ============================================================
# FOOTBALL AI V2 STABLE REV10.4 – Horizontal Score Cards
# ============================================================
...
# ============================================================
# PENDING MANAGER (Accordion + Horizontal Input)
# ============================================================
def render_pending():
...
def render_pending_card(row, idx, pending_all, db):
    ...
    # Horizontal score cards: 4 kolom dalam satu baris
    col_ht_home, col_ht_away, col_ft_home, col_ft_away = st.columns(4)
    with col_ht_home:
