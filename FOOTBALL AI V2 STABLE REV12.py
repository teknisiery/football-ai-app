# ============================================================
# FOOTBALL AI V2 STABLE REV10 – PENDING CONTRACT DEFINITION
# Golden Baseline REV8 + PendingContract sebagai SSOT
# ============================================================
...
class PendingContract:
    ...
    """
    # Kolom inti yang harus ada di setiap record Pending
    CORE_COLUMNS = [
        # Identity (dari PendingSchema)
        ...
        # Score columns (diisi oleh user melalui Pending Manager)
        "home_ht_goals", "away_ht_goals", "home_goals", "away_goals",
        # Settlement results (akan diisi oleh Settlement Engine, tetapi kolom harus ada)
    ...
    def normalize(cls, df: pd.DataFrame) -> pd.DataFrame:
        """
        Pastikan semua kolom inti ada di DataFrame.
        Jika tidak, tambahkan dengan nilai default.
        Operasi idempotent dan tidak mengubah data existing.
        """
        df = df.copy()
...
def build_pending(ctx: PredictionContext) -> PendingResult:
    ...
    # **Contract Enforcement**: pastikan schema sesuai SSOT sebelum disimpan
...
# ============================================================
# PENDING MANAGER (Editable Table)
# ============================================================
def render_pending():
    ...
    # Kolom skor sudah dijamin ada oleh contract, aman untuk diakses
