...
from services.model_evaluator import evaluate_model        # <-- import baru
...
# ============================================================
# FEATURE ENGINEERING (dipindahkan ke services/feature_eng.py)
# ============================================================
# Fungsi add_features() sekarang berada di services/feature_eng.py
# dan diimpor di bagian atas file ini.
...
def get_match_prediction_summary(session: SessionManager, storage: StorageProvider):
    ...
    # --- PERBAIKAN: sinkronkan cs_recommendations dengan hybrid_top3 ---
    cs_recs = None
    odds_dict = session.uploaded_odds
    hybrid_top3 = None

    if odds_dict:
        # Hitung hybrid top 3 terlebih dahulu
        ...
        # Tentukan skor yang akan digunakan untuk rekomendasi CS
...
# ============================================================
# MODEL EVALUATION (dipindahkan ke services/model_evaluator.py)
# ============================================================
# Fungsi evaluate_model() sekarang berada di services/model_evaluator.py
# dan diimpor di bagian atas file ini.
