...
# + Grafik Plotly & Profit per Bulan (Bahasa Indonesia)
# + Profit per Liga di Sidebar
# + Log Riwayat Profil Liga
...
LEAGUE_ROUND_CONFIG = {
    ...
    16736: {'teams': 14, 'matches_per_round': 7},
}
    ...
    with st.sidebar:
        ...
        if monthly_data:
            ...
            for bulan_key in sorted(monthly_data.keys(), reverse=True):
                ...
                # Konversi label: "YYYY-MM" -> "Bulan Tahun"
        ...
        if league_data:
            ...
            for league in sorted(league_data.keys()):
                ...
                with st.expander(f"{league} - Rp {data['profit']:+,.0f}"):
                    ...
                    # Grafik cumulative profit liga jika memungkinkan
