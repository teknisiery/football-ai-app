# ============================================================
# FOOTBALL AI V2 STABLE REV8 FINAL (APP.PY LENGKAP)
# Golden Baseline REV7 + Directive 034 Patch + Perbaikan data_editor
# ============================================================
...
def render_settlement():
    ...
    if synced > 0:
        st.success(f"{synced} pertandingan disinkronkan ke History."); st.rerun()
        return
...
def render_pending():
    ...
    if st.button("💾 Save Changes"):
        ...
        for idx, row in edited_df.iterrows():
            ...
            if not original[PendingSchema.PREDICTION_STATUS] in editable_status: continue
        ...
        if changed:
            ...
            st.success("Perubahan disimpan."); st.rerun()
