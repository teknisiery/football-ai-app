...
# + Poisson Asimetris & Dixon-Coles (Over/Under + Top 3 Skor)
# ============================================================
...
# ============================================================
# PREDICTION ENGINE (Poisson Asimetris + Dixon-Coles)
# ============================================================
@dataclass
...
class Predictor:
    ...
    def predict(self, features_df: pd.DataFrame) -> PredictionResult:
        ...
        # Ambil xG tim, fallback ke lam/2 jika tidak tersedia
        try:
        ...
        # Skalakan sehingga total expected goal = lam
        ...
        # Parameter korelasi Dixon-Coles
        rho = -0.1
        max_goals = 7   # cukup untuk cakupan probabilitas tinggi
        ...
        for h in range(0, max_goals+1):
            for a in range(0, max_goals+1):
                ...
                if total_goals > ou_line:
                    prob_over_new += prob
                # under dan push tidak diperlukan untuk perhitungan prob_over

        # Top 3 skor
        top3 = sorted(scores, key=lambda x: x[2], reverse=True)[:3]

        # Probabilitas Over final (sebelum kalibrasi)
        prob_raw = prob_over_new
        prob_over = prob_raw
        ...
        return PredictionResult(
            ...
            prediction_ou=int(prob_over >= 0.5),
...
# ============================================================
# PAGES (unchanged except render_learning & evaluate_model)
# ============================================================
