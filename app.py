# ============================================================
# FOOTBALL AI V2 STABLE REV10.6 – Settlement Workflow & UI
# ============================================================
...
# ============================================================
# CUSTOM CSS (ditambah kelas untuk HT/FT card)
# ============================================================
st.markdown("""
<style>
...
/* Mini-card untuk input skor – HT dengan background putih */
.ht-score-card {
    background: #ffffff;
    border-radius: 16px;
    padding: 12px 8px;
...
/* Mini-card untuk FT dengan background merah */
.ft-score-card {
    background: #ef4444;
    border-radius: 16px;
    padding: 12px 8px;
...
def save_pending_score(idx, ht_home, ht_away, ft_home, ft_away, pending_all, db):
    ...
    if valid:
        ...
        # Pindahkan record ke history
        try:
            history = db.load_history()
        except:
            history = pd.DataFrame()

        # Pastikan kolom sesuai kontrak (sama dengan pending)
