...
def calculate_live_recommendation(
    ...
    # Probabilitas dasar over (tanpa kalibrasi, agar sederhana)
    ...
    # Rekomendasi sederhana: jika prob_over >= 0.5 maka OVER, else UNDER, atau NO BET jika ev negatif
    ...
    # 5. BTTS menggunakan Poisson (dua tim cetak gol independen)
