...
# + Split Quarter Handicap, Perbaikan Bug, Detail Profit per Status
# ============================================================
...
def calculate_profit(row: dict, stake: float = 100000.0) -> Tuple[float, str]:
    ...
    # Tentukan arah taruhan (OVER/UNDER) dengan fallback aman dari NaN
    ...
    if 'settlement_time' in df.columns:
        ...
        for bulan, group in monthly_groups:
            ...
            monthly_data[bulan] = {
                ...
                'df': group  # untuk grafik & profit per status bulanan
            }
    else:
        monthly_data = {}
...
# ============================================================
# PAGES (sebagian besar tidak berubah, hanya settlement disesuaikan)
# ============================================================
...
# ============================================================
# MAIN APP (dengan sidebar yang diperbarui: profit per status)
# ============================================================
def main():
    ...
    with st.sidebar:
        ...
        # Statistik ringkas all time (jumlah)
