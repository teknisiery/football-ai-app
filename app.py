...
from services.match_pnl import build_match_pnl, apply_1x2_odds_floor, ONE_X_TWO_MIN_ODDS
...
def render_match_pnl(session: SessionManager, storage: StorageProvider):
    ...
    for result in results:
        ...
        with st.expander(f"{home} vs {away} — {net_text} | Skor {score}"):
            ...
            for leg in result["legs"]:
                st.markdown(
                    f"**{safe_html(leg['market'])}**  \n"
                    f"Modal &nbsp;&nbsp;&nbsp; Rp {leg['stake']:,.0f}  \n"
                    f"Odds &nbsp;&nbsp;&nbsp;&nbsp; {leg['odds']:.2f}  \n"
                    f"Hasil &nbsp;&nbsp;&nbsp;&nbsp; **{safe_html(leg['result'])}**  \n"
                    f"P/L &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **Rp {leg['pnl']:+,.0f}**"
                )
                st.markdown("")
