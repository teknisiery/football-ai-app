# ============================================================
# FOOTBALL AI V2 STABLE REV10.1 – Fix data_editor TypeError
# ============================================================
...
def render_pending():
    ...
    # Perbaikan: gunakan disabled=False untuk semua kolom input,
    # karena pembatasan edit berdasarkan status dilakukan pada saat penyimpanan.
    column_config = {
