...
# + Perbaikan bug Top 3 Skor (lam/2)
# ============================================================
...
# ============================================================
# PREDICTION ENGINE (Top 3 Skor diperbaiki: lam/2)
# ============================================================
@dataclass
...
class Predictor:
    ...
    def predict(self, features_df: pd.DataFrame) -> PredictionResult:
        ...
        # Top 3 Skor – PERBAIKAN: masing‑masing tim memiliki expected goal = lam/2
        lam_per_team = lam / 2.0
        scores = []
        for h in range(0, 6):
            for a in range(0, 6):
                prob = poisson.pmf(h, lam_per_team) * poisson.pmf(a, lam_per_team)
