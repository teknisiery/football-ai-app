...
# + Evaluasi Lengkap (Klasifikasi, Kalibrasi, Finansial) + Top 3 Skor
# ============================================================
...
# ============================================================
# PREDICTION ENGINE (ditambahkan top3_scores)
# ============================================================
@dataclass
...
class Predictor:
    ...
    def predict(self, features_df: pd.DataFrame) -> PredictionResult:
        ...
        for h in range(0, 6):
            for a in range(0, 6):
                prob = poisson.pmf(h, lam) * poisson.pmf(a, lam)
...
# ============================================================
# UI COMPONENTS (ditambahkan top 3 skor di kartu)
# ============================================================
...
# ============================================================
# EVALUASI MODEL (LENGKAP, CACHE MANUAL)
# ============================================================
def evaluate_model(storage: StorageProvider) -> dict:
    ...
    # Siapkan totalgol_ft jika belum ada
    if 'totalgol_ft' not in df.columns:
    ...
    # Regresi (hanya baris yang memiliki expected_goal dan totalgol_ft)
    ...
    # Klasifikasi dan kalibrasi (butuh actual_over, prediction_ou, prob_over)
    df['total_goals'] = df['home_goals'] + df['away_goals']
    df['actual_over'] = np.where(df['total_goals'] > df['current_ou'], 1,
                                 np.where(df['total_goals'] < df['current_ou'], 0, np.nan))
    # Hanya baris yang tidak push dan memiliki prediction_ou valid
    ...
    # Finansial (taruhan yang dipasang)
    fin_df = df.copy()
