# ============================================================
# FOOTBALL AI V2 STABLE REV10.2 – Final Fix (Record Editing)
# ============================================================
...
# ============================================================
# PENDING MANAGER (Record Editing)
# ============================================================
def render_pending():
...
def render_pending_card(row, idx, pending_all, db):
    with st.container():
        ...
        col_ht1, col_ht2, col_ft1, col_ft2 = st.columns(4)
        with col_ht1:
