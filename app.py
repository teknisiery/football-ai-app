# ============================================================
# FOOTBALL AI V2 STABLE REV10.5 – Compact Horizontal Score Cards
# ============================================================
...
# ============================================================
# CUSTOM CSS (termasuk mini‑card untuk input skor)
# ============================================================
st.markdown("""
<style>
...
/* Mini-card untuk input skor agar konsisten dengan dashboard */
.mini-score-card {
    background: #1e293b;
    border-radius: 16px;
    padding: 12px 8px;
...
# ============================================================
# PENDING MANAGER (Accordion + Horizontal 2×2 Input)
# ============================================================
def render_pending():
...
def render_pending_card(row, idx, pending_all, db):
    ...
    # Layout 2×2 horizontal dengan mini‑card (opsional)
    # Baris 1: HT Home & HT Away
    col1, col2 = st.columns(2)
    with col1:
        with st.container():
            st.markdown('<div class="mini-score-card"><div class="label">HT HOME</div>', unsafe_allow_html=True)
    ...
    with col2:
        with st.container():
            st.markdown('<div class="mini-score-card"><div class="label">HT AWAY</div>', unsafe_allow_html=True)
    ...
    # Baris 2: FT Home & FT Away
    col3, col4 = st.columns(2)
    with col3:
        with st.container():
            st.markdown('<div class="mini-score-card"><div class="label">FT HOME</div>', unsafe_allow_html=True)
    ...
    with col4:
        with st.container():
            st.markdown('<div class="mini-score-card"><div class="label">FT AWAY</div>', unsafe_allow_html=True)
...
def save_pending_score(idx, ht_home, ht_away, ft_home, ft_away, pending_all, db):
    ...
    if valid:
        ...
        st.success("Skor disimpan dan tervalidasi.")
    else:
