...
def parse_score_distribution_text(raw_text: str, total_matches: int = 0) -> Dict[str, int]:
                ...
                if 'edit_league_code' in st.session_state and st.session_state['edit_league_code'] is not None:
                    ...
                    if mask.any():
                        ...
                        with st.expander("⚽ Distribusi Skor Kombinasi"):
                            ...
                            # Pastikan session state untuk hasil parse diinisialisasi
                            if 'parsed_score_counts' not in st.session_state:
                                st.session_state['parsed_score_counts'] = {}

                            # Letakkan blok parse SEBELUM input number agar nilai hasil parse terbaca
                            ...
                            # Gunakan hasil parse jika tersedia, selain itu gunakan distribusi tersimpan
