# ============================================================
# FOOTBALL AI V2 STABLE REV25 – Fix Home/Away Team in Datasets
# ============================================================
...
def append_raw_dataset(uploaded_df: pd.DataFrame, home_team: str, away_team: str):
    """Append validated match to dataset_ou.csv (raw), adding home_team and away_team."""
    df = uploaded_df.copy()
...
def append_training_dataset(uploaded_df: pd.DataFrame, home_team: str, away_team: str):
    """Copy raw data, tambah kolom team, match_uid, dan goal, simpan ke dataset_withgoal.csv."""
    df = uploaded_df.copy()
    df["home_team"] = home_team
    df["away_team"] = away_team
    ...
    def run_analysis(self, uploaded_file) -> dict:
        ...
        if context.get("validation_success",False):
            ...
            try:
                ...
                append_raw_dataset(upload_df, home, away)      # <-- sekarang menerima home/away
