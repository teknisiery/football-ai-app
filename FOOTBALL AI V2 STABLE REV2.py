...
def get_match_prediction_summary():
    ...
    stake_new = 100000 if rec != "NO BET" else 0
    ...
    return {
        ...
        "edge": dec["edge"],
        "ev_over": dec["ev_over"],
        "ev_under": dec["ev_under"],
        "kelly_over": dec["kelly_over"],
        "kelly_under": dec["kelly_under"],
        "grade": dec["grade"],
        "historical_roi": dec["historical_roi"],
        "historical_win_rate": dec["historical_win_rate"],
        "recommendation": rec,
        "rec_color": dec["rec_color"],
        "stake": stake_new,
        "over_odds": feat_row.get("current_over_odds"),
        "under_odds": feat_row.get("current_under_odds"),
        "football_brain": dec["football_brain"],
        "league_brain": dec["league_brain"],
        "market_brain": dec["market_brain"],
        "ai_score": dec["ai_score"],
        "btts_pred": dec["btts_pred"],
        "prob_btts": dec["prob_btts"],
        "confidence_btts": dec["confidence_btts"],
        "ht0_pred": dec["ht0_pred"],
        "prob_ht0": dec["prob_ht0"],
        "confidence_ht0": dec["confidence_ht0"],
